import type { InfoOverlayConfig } from '../../shared/types.js'
...
`
export const SHEET_BACK_ICON_SVG = `
...
`
export const INFO_SHEET_DEFAULT_TITLE = '说明'
export const INFO_SHEET_FALLBACK_CONFIG: InfoOverlayConfig = {
...
`
export const SHARE_ICON_WHITE_SVG = `
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
...
`
export const SURFACE_MARKER_SVG = `
...
`
export const SURFACE_MARKER_SELECTED_SVG = `
<svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
