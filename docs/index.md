...
Last sync: Workbench 0.4.0 / GuideAuthoringBundle v1 / atomic authoring create (2026-07-21)
...
| orchestration    | `src/automation/` + Workbench automation routes | [Workbench–Skill 离线编排](architecture/workbench-skill-offline-orchestration.md) | [Authoring API](api/automation-v1-authoring.md) | Review 与发布门禁                                      | 🟡 创建已实现，ChangeSet 待实现 |

### Development

| Doc                                                                                                       | Description                                                                                                                                                                                                                                                                                                                                                                      |
| --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Workbench 与 Skill 双版本离线编排架构](architecture/workbench-skill-offline-orchestration.md)            | 独立版本边界、素材收集、能力协商、原子创建、人工批准与离线发行 (2026-07-21)                                                                                                                                                                                                                                                                                                      |
| [Automation v1 Authoring API](api/automation-v1-authoring.md)                                             | 内容寻址 Blob、GuideAuthoringBundle v1、只读校验、原子创建、幂等与中断恢复 (2026-07-21)                                                                                                                                                                                                                                                                                          |
