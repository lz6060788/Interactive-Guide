...
Last sync: Gallery 纵向滚动实验、跨语言 focus 与英文编辑验收 (2026-07-22)
...
| Doc | Description |
|-----|-------------|
| [Gallery 真实数据与产物验收记录](development/gallery-real-data-acceptance-2026-07-22.md) | 半导体设备 29 节点 / 29 PNG 映射、纵向滚动实验、跨语言 URL 聚焦与英文工作台验收 (2026-07-22) |
