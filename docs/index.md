...
Last sync: Workbench 0.5.0 / Bundle + ChangeSet + State v1 / offline Workbench package (2026-07-21)
...
| orchestration    | `src/automation/` + Workbench automation routes | [Workbench–Skill 离线编排](architecture/workbench-skill-offline-orchestration.md) | [Authoring API](api/automation-v1-authoring.md) | Review、发布门禁与离线包                               | 🟡 Workbench 边界完成，薄 Skill 待实现 |

### Development

| Doc                                                                                                       | Description                                                                                                                                                                                                                                                                                                                                                                      |
| --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Workbench 与 Skill 双版本离线编排架构](architecture/workbench-skill-offline-orchestration.md)            | 独立版本边界、素材收集、Bundle/ChangeSet/State、人工批准与平台化离线 Workbench 包 (2026-07-21)                                                                                                                                                                                                                                                                                   |
| [Automation v1 Authoring API](api/automation-v1-authoring.md)                                             | 内容寻址 Blob、Bundle 原子创建、ChangeSet 原子修改、无路径 State、幂等与中断恢复 (2026-07-21)                                                                                                                                                                                                                                                                                    |
