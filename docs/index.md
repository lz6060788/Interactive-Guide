...
Last sync: Gallery 验证项目完整英文内容、跨语言 focus 与首次滚动稳定性验收 (2026-07-22)
...
| server           | `src/server/`           | [旧后端设计（已归档）](architecture/后端详细设计方案.md)   | —                                                                                        | [构建任务流](architecture/构建任务流与目录结构设计.md)                         | ✅     |
...
| Doc                                                                                                       | Description                                                                                                                                                                                                                                                                                                                                                                      |
| --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Gallery 真实数据与产物验收记录](development/gallery-real-data-acceptance-2026-07-22.md)                  | 半导体设备 29 节点 / 29 PNG、完整中英文内容、纵向滚动与跨语言 URL 聚焦验收 (2026-07-22)                                                                                                                                                                                                                                                                                          |
| [离线 Skill 组装架构](architecture/offline-skill-packaging.md)                                            | Skill 编排层、Workbench 构建闭包、回环运行时与可选产物交付边界 (2026-07-24)                                                                                                                                                                                                                                                                                                      |
